...
export default (({ handleModal, isSubmitting, setAcertos }: props) => {
    ...
    const [respostas, setRespostas] = useState(['D', 'D', 'C', 'A', 'B', 'B', 'B', 'D', 'C', 'B'])
    ...
    return (
        <div className="grid grid-cols-1 gap-6">
            ...
            {/* QUESTÃO 1 */}
            <label><strong>1)</strong> A função de Consultor Caixa é muito importante em uma empresa. O consultor caixa pode ser comparado ao engenheiro de uma obra ou ao professor de uma escola. São pessoas-chave dentro de suas empresas porque:</label>

            <label htmlFor="">I.Relacionam-se constantemente com os clientes e com o dinheiro da empresa.</label>
            <label htmlFor="">II.São responsáveis por toda a movimentação financeira da empresa, dando ênfase ao pagamento dos colaboradores e dos fornecedores.</label>
            <label htmlFor="">III.São profissionais com a preocupação em atender bem ao cliente, pois começam o atendimento e finalizam a venda.</label>

            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 0)} value="A" id="q1a" name="q1" label_input="Apenas a afirmativa I está correta." />
            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 0)} value="B" id="q1b" name="q1" label_input="Apenas a afirmativa II está correta." />
            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 0)} value="C" id="q1c" name="q1" label_input="Apenas a afirmativa III está correta." />
            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 0)} value="D" id="q1d" name="q1" label_input="Apenas as afirmativas I e III estão corretas." />
            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 0)} value="E" id="q1e" name="q1" label_input="Apenas as afirmativas II e III estão corretas." />

            {/* QUESTÃO 2 */}
            <label><strong>2)</strong> Você é o Consultor Caixa da Drogaria x, foi solicitado para que dê expediente em outra filial para cobrir a ausência de um colega afastado por doença. Ao chegar ao local você encontrou o Sistema de Operação de Caixa sinalizando CAIXA ABERTO. O procedimento CORRETO para resolver tal ocorrência é: </label>
            ...
            <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 1)} value="D" id="q2d" name="q2" label_input="Solicitar a presença do supervisor de caixa (gestor) para as providências de rotina." />
            ...
            {/* QUESTÃO 3 */}
            <label><strong>3)</strong> Ao finalizar a dispensação, o consultor caixa fará o registro da venda de produtos. A informatização de tais processos exigiu das empresas a elaboração de um código digital para facilitar o registro dos produtos chamado tecnicamente de:  </label>
            ...
            {/* QUESTÃO 10 */}
                        <label><strong>10)</strong> A qual grupo de medicamentos corresponde a afirmativa abaixo?
            “Medicamento elaborado a partir de derivados de Plantas medicinais tais como: suco, cera, exsudato, óleo, extrato, tintura, entre outros. ”</label>
            
                        <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 9)} value="A" id="q10a" name="q10" label_input="Medicamento fitoterápico." />
                        <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 9)} value="B" id="q10b" name="q10" label_input="Medicamento alopático." />
                        <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 9)} value="C" id="q10c" name="q10" label_input="Medicamento homeopático." />
                        <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 9)} value="D" id="q10d" name="q10" label_input="Medicamento genérico." />
                        <InputQuestForm handleGetQ={(e: any) => handleGetQ(e, 9)} value="E" id="q10e" name="q10" label_input="Medicamento de referência." />
